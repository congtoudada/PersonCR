...
def alignment_and_crop_face(src_img, facial_pts, reference_pts=None, crop_size=(96, 112), align_type='smilarity'):
    '''
    ...
    '''
    assert crop_size == (96, 112) or crop_size == [96, 112] or \
           crop_size == (112, 112) or crop_size == [112, 112]
